        ...
        <div className="sidebar pb-5">
            ...
            <div style={{userSelect:'none'}}  className='SidebarItems mt-0 mt-5 mx-0 px-0'>
                ...
                <div className={`sidebar_span_cont ${!masterActive && "d-none"}`}>
                    ...
                    <span className='SidebarSpan d-flex ms-5 ps-3'>
                        <div className='SidebarItemText' onClick={()=>navigate('/material-composition-product')}>Material Composition</div>
                    </span>
                ...
                <div className={`sidebar_span_cont ${!ReportsActive && "d-none"}`}>
                    ...
                    <span className='SidebarSpan d-flex ms-5 ps-3'>
                        <div className='SidebarItemText' onClick={()=>navigate('/cheque-register')}>Cheque Register</div>
                    </span>
                ...
                <div className={`sidebar_span_cont ${!ArrowActive && "d-none"}`}>
                    ...
                    <span className='SidebarSpan d-flex ms-5 ps-3'>
                        <div className='SidebarItemText' onClick={()=>navigate('/Stock-journal-report')}>Stock Journal</div>
                    </span>
                    <span className='SidebarSpan d-flex ms-5 ps-3'>
                        <div className='SidebarItemText' onClick={()=>navigate('/profit-report')}>Item Wise Profit</div>
                    </span>
                    <span className='SidebarSpan d-flex ms-5 ps-3'>
                        <div className='SidebarItemText' onClick={()=>navigate('/purchase-book')}>Purchase Report</div>
                    </span>
                    <span className='SidebarSpan d-flex ms-5 ps-3'>
                    ...
                    </span>                    <span className='SidebarSpan d-flex ms-5 ps-3'>
                        <div className='SidebarItemText' onClick={()=>navigate('/bill-wise-profit')}>Bill Wise Profit</div>
                    </span>
                    <span className='SidebarSpan d-flex ms-5 ps-3'>
                        <div className='SidebarItemText' onClick={()=>navigate('/cheque-register-report')}>Cheque Register</div>
                    </span>
                    <span className='SidebarSpan d-flex ms-5 ps-3'>
                        <div className='SidebarItemText' onClick={()=>navigate('/stock-value-report')}>Stock Value Report</div>
                    </span>
                    <span className='SidebarSpan d-flex ms-5 ps-3'>
