    ...
    return (
        <div className="header px-4 py-3 d-flex justify-content-between bg-dark text-light">
           ...
           <div className='d-flex gap-3 align-items-center'>
            <div className='seach_bar_cont rounded-2'><img src={search} className='search_img me-3 ms-2 py-2'/><input className='search_bar rounded-2 border-0 py-1' placeholder='Search' type/></div>
