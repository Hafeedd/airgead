...
// import module from '../../../assets/files/Modules.xlsx'

// const workbook = XLSX.read(module, { type: 'array' });
// const sheetName = workbook.SheetNames[0];
// const worksheet = workbook.Sheets[sheetName];
// const jsonData = XLSX.utils.sheet_to_json(worksheet,{header:1});

// export const companyModules = jsonData
...
export const companyModules = [
  ...
  {name:'Purchase Return',code:101,icon:'https://icons.foxa.in/media/icons/undo.svg',	parent:100	,primary:'YES'},
  {name:'Purchase Report',code:102,parent:100	,primary:'YES'},
  {name:'Purchase Order',code:103,primary:'YES'},
  {name:'Sales',code:104,icon:'https://icons.foxa.in/media/icons/point-of-sale-bill.svg'		,primary:'YES'},
  {name:'Sales Return',code:	105,icon:'https://icons.foxa.in/media/icons/cart-minus.svg',parent:	104	,primary:'YES'},
  {name:'Sales Report',code:106,parent:104	,primary:'YES'},
  {name:'Sales Order',code:107,primary:'YES'},
  {name:'Payment',code:	108,primary:'YES'},
  {name:'Receipt',code:109,icon:'https://icons.foxa.in/media/icons/point-of-sale-bill.svg',parent:	108	,primary:'YES'},
  {name:'Stock Journal',code:110,icon:'https://icons.foxa.in/media/icons/document-signed_p9I0WXo.svg',primary:'YES'},
  {name:'Stock Journal Report',code:111,parent:110,primary:'YES'},
  {name:'Account Journal',code:116,icon:'https://icons.foxa.in/media/icons/document-signed_p9I0WXo.svg',parent:	112	,primary:'YES'},
  {name:'Chart Of Account Report',code:117,parent:116,primary:'YES'},
  {name:'Customer Out Standing Report',code:118,parent:112,primary:'YES'},
  {name:'Supplier Out Standing Report',code:119,parent:112,primary:'YES'},
  {name:'Daybook Report',code:120,parent:112,primary:'YES'},
  {name:'CashBook Report',code:121,parent:112,primary:'YES'},
  {name:'Account Ledger Report',code:122,parent:112,primary:'YES'},
  {name:'Staff',code:123,primary:'YES'},
  {name:'Staff Attendance',code:125,icon:'https://icons.foxa.in/media/icons/document-signed.svg',parent:	123	,primary:'YES'},
  {name:'Payroll',code:126,icon:'https://icons.foxa.in/media/icons/cost-per-lead_11336391.png',parent:	123	,primary:'YES'},
  {name:'Staff Attendance Report',code:	127,parent:123,primary:'YES'},
  {name:'Staff Salary Report',code:128,parent:123,primary:'YES'},
  {name:'Staff Out Standing Report',code:129,parent:123,primary:'YES'},
  ...
  {name:'Stock Ledger Report',code:139,parent:133,primary:'YES'},
  {name:'Barcode RegisterReport',code:140,parent:133,primary:'YES'},
  {name:'Trial Balance Report',code:141,parent:112,primary:'YES'},
  {name:'Group Wise Trial Balance Report',code:142,parent:112,primary:'YES'},
  {name:'Balance Sheet Report',code:143,parent:112,primary:'YES'},
  {name:'Group Wise Balance Sheet Report',code:144,parent:112,primary:'YES'},
  {name:'Detailed Balance Sheet Report',code:145,parent:112,primary:'YES'},
  {name:'Bill Wise Ledger Report',code:146,parent:112,primary:'YES'},
  {name:'Bill Wise Profit Report',code:147,parent:112,primary:'YES'},
  {name:'Production',code:148,icon:'https://icons.foxa.in/media/icons/product-management_12525462.png',primary:'YES'},
  {name:'Production Report',code:150,parent:148,primary:'YES'},
  {name:'Traiding & Profit And Loss Report',code:151,primary:'YES'},
  {name:'User Out Standing',code:152,parent:112,primary:'YES'},
  {name:'Dashboard',code:154,primary:'YES'},
]
...
export const permissions =
{
  ...
  Account: {
    ...
    'ACCOUNT GROUP': [
      ...
      { key: 435, name: 'Account Group Edit', code: 1434 },
