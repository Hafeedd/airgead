export const companyModules = [
  ...
  { name: 'Purchase Order', code: 107, primary: 'YES' },
  ...
  { name: 'Stock Journal', code: 122, icon: 'https://icons.foxa.in/media/icons/document-signed_p9I0WXo.svg', primary: 'YES' },
  { name: 'Account Journal', code: 129, icon: 'https://icons.foxa.in/media/icons/document-signed_p9I0WXo.svg', primary: 'YES' },
  ...
  { name: 'Item', code: 147,parent:124, primary: 'YES' },
