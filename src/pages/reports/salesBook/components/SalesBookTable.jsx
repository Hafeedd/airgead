        ...
        >
          <div className="col-3 p-2 stock-ledger-search d-flex align-items-center">
            <div className="col-1 me-2">
              <GrRefresh onClick={()=>setSearchedList(salesBookList)} className="bg-light m-1 p-1 rounded-1" size={20} />
            </div>
            ...
            {searchedList?.length > 0 ? (
              searchedList.map((data, i) => (
                <tr key={i}>
                  ...
                  <td>
                    {data?.total_amount -
                      (data?.total_sgst + data?.total_sgst) || "0"}
                  </td>
                  ...
                  <td>{data.total_amount - data.received_amount || "0"}</td>
                </tr>
              ))
            ) : (
              <tr>
