      ...
      <div className="stock-ledger-cont">
        <table className="stock-ledger table w-100">
          <thead>
            ...
            <th>
              <div className="grn_th rounded-top-2 rounded-end-0">Purchase</div>
            </th>
            <th>
            ...
            <th>
              <div className="brn_th rounded-top-2 rounded-end-0">P.return</div>
            </th>
            <th>
          ...
          <tbody>
            {searchedList?.length > 0 &&
              searchedList.map((data, i) => {
                return (
                  <>
                    <tr className="stock-ledger-item-tr"><td colspan={13}>{data.item_name}</td></tr>
                    ...
                    return <tr key={i}>
                      ...
                      <td>
                        <div className="prple_td" width="70">
