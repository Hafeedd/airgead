...
const TraidProfitLossEntry = (props) => {
    const {params, setParams} = props

    console.log(params.to_date,"from")
    console.log(params.from_date,"to")

    const handleChange = (data)=>{
        if (data.target.value == ""){
            setParams({...params,[data.target.name]: null})
        }
        else{
            setParams(param=>({...param,[data.target.name]: data.target.value}))
        }
    }
    return (
...
export default TraidProfitLossEntry