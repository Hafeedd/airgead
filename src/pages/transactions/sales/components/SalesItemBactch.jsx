...
const SalesItemBactch = (props) => {
    const {setSalesBatchShow,salesBatchShow,tableItemBatch,
      tableItemBatchList,purchaseItemList,salesAdd,setSalesAdd} = props
      ...
      const handleDataSelection = (data) =>{
        ...
        setSalesAdd((item)=>({...item,fk_items:data.id,
        code:data.code,item_name:data.item_name,unit:data.unit}))
      }
    ...
    <table className="table sales-batch-table col-12">
        ...
        {tableData.length>0?
                tableData.map((data,i)=>(
                  <tr onClick={()=>handleDataSelection(data)} className="batch-seriel-row" key={i}>
                  <td><div className="tbodytd" >
                    <input disabled placeholder="..." value={data.code||''}/></div>
                  </td>
                
                  <td>
                    <div className="tbodytd">
                        <input disabled className="text-center"
                        placeholder="..." value={data.item_name||''}/></div>
                      </td>
                  
                  <td>
                    <div className="tbodytd">
                        <input disabled className="text-center"
                        placeholder="..." value={data.rate||''}/></div>
                      </td>
                  
                  <td>
                    <div className="tbodytd">
                        <input disabled className="text-center"
                        placeholder="..." value={data.cost||''}/></div>
                      </td>
                  
                  <td>
                    <div className="tbodytd">
                        <input disabled className="text-center"
                        placeholder="..." value={data.total||''}/></div>
                      </td>
                  ...
                  <td>
                    <div className="tbodytd">
                        <input disabled className="text-center"
                        placeholder="..." value={data.sales_rate||''}/></div>
                      </td>

                  <td>
                    <div className="tbodytd">
                        <input disabled className="text-center"
                        placeholder="..." value={data.margin||''}/></div>
                      </td>

                  <td>
                    <div className="tbodytd">
                        <input disabled className="text-center"
                        placeholder="..." value={data.value||''}/></div>
                      </td>
                </tr>
              ))
              // ))
            :<tr><td colSpan={9} className="pt-4 fs-5">No item Added yet</td></tr>}
        ...
        <button onClick={()=>setSalesBatchShow(false)} className="btn sales-batch-cbtn py-1 col-1 col-2 me-2">Close</button>
