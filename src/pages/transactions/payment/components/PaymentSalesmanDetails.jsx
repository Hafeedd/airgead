    ...
    <div className="col-12 row mx-0 p-5 pt-3 payment-detail-container">
        <div className="col-12 row mx-0 mb-1 px-0">
            ...
            <div className='mx-0 px-0 col-9'>
                <input onChange={handleChange} name='salesman' value={paymentAdd.salesman ? paymentAdd.salesman : ''} type='text' className='item_input names' />
            </div>
        </div>
        <div className="col-12 row mx-0 my-1 px-0">
            ...
            <div className='mx-0 px-0 col-5 col-6'>
                <input onChange={handleChange} name='commision' value={paymentAdd.commision ? paymentAdd.commision : ''} type='number' className='item_input names bg-dark text-light' />
            </div>
